  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[300px] md:h-[500px]">
        ...
        <Image
          src="https://res.cloudinary.com/dmtmat9y5/image/upload/v1724610733/women_ysaszk.jpg"
      ...
      {/* Content Section */}
      <div className="max-w-4xl mx-auto p-6 md:p-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg shadow-2xl font-serif transform transition duration-500 hover:scale-105 mt-6 md:mt-10">
